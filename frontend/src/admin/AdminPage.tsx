...
// Tab Components
import AdminAnalyticsTab from '../shared/components/admin/AdminAnalyticsTab';
import AdminUsersTab from '../shared/components/admin/AdminUsersTab';
import AdminProjectsTab from '../shared/components/admin/AdminProjectsTab';
import AdminSecurityTab from '../shared/components/admin/AdminSecurityTab';
import AdminSettingsTab from '../shared/components/admin/AdminSettingsTab';
