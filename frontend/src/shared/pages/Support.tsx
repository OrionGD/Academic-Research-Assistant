...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Your data is encrypted both in transit and at rest. We use secure session-based authentication and follow industry best practices for data isolation.'
  },
  {
