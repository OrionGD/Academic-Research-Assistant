...
export default function CollectionsPage() {
  ...
  const collections = [
    { id: '1', name: 'LLM Architectures', count: 6, description: 'Papers focusing on Transformer variants and scaling laws.' },
    { id: '2', name: 'Neural Retrieval', count: 9, description: 'Dense vs Sparse retrieval methods and hybrid systems.' },
    { id: '3', name: 'Biomedical AI', count: 7, description: 'Applications of large language models in healthcare.' },
  ];
          ...
          {collections.map((col) => (
            <motion.div
              ...
              className={cn(
                ...
                activeCollectionId === col.id ? "border-accent/40 bg-accent/[0.02]" : "border-white/5"
              )}
            ...
            >
              ...
              <div className="flex items-start justify-between">
                <div className={cn(
                  ...
                  activeCollectionId === col.id ? "bg-accent/20 border-accent/40 text-accent" : "bg-white/5 border-white/10 text-text-dim"
                )}>
                  <Layers size={24} />
                </div>
                <button
