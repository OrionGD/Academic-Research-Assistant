...
import { GraduationCap, Mail, Lock, Loader2, AlertCircle, User } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-bg-dark p-6">
      ...
      >
        <div className="text-center mb-10">
          <div className="w-16 h-16 bg-accent-primary rounded-2xl flex items-center justify-center text-bg-dark mx-auto mb-6 shadow-xl shadow-accent-primary/20">
