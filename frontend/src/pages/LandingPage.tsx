          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
            <div className="lg:col-span-1">
              <div className="flex items-center gap-2.5 mb-6">
                <div className="w-10 h-10 bg-accent-primary rounded-xl flex items-center justify-center text-bg-dark">
                  <GraduationCap size={24} />
                </div>
                <span className="font-bold text-2xl tracking-tight">ScholarAI</span>
              </div>
